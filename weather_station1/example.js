    ...
    const selectMenuHtml = `
      <p>MyStyle selector</p>
              ...
              <div id="selectNameDiv">
                <p>Pick a measurement:</p><p><select id='selectName' class='form-control selcls'>
                <option value="0">Temperature</option>
                <option value="24" selected>Humidity</option>
                <option value="48">Rain</option>
                <option value="72">Wind Speed</option>
